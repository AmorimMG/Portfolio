...
const CadastrosDashboard = () => import('@/views/pages/cadastros/CadastrosDashboard.vue');
...
router.beforeEach(async (to, from, next) => {
    const workerPaths = ['/whatsappclone', '/cv', '/en.html', '/index.html', '/netflixclone', '/rawg', '/instagramclone', '/snakeclone', '/crudbasic'];
