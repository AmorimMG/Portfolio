...
<template>
    ...
    <div class="layout-main-container">
        ...
        <div id="components-container" :class="{ hidden: !isStarted, 'fade-in': isStarted }" class="grid components-container justify-content-center">
            <!-- <app-topbar :applyGlitchEffect="applyGlitchEffect" /> -->

            <div :style="{ display: menuVisible ? 'flex' : 'none' }" id="Introduction" class="col-4 lg:col-3 xl:col-3 p-0">
                <Introduction :menuVisible="menuVisible" @update:menuVisible="menuVisible = $event" />
            </div>
            <draggable :style="{ display: !menuVisible ? 'grid' : '' }" id="draggableCards" class="draggable col-12 lg:col-9 xl:col-9" v-model="cards" item-key="id" group="cards" animation="200">
