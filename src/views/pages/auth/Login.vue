...
<template>
	<Toast />
	<Background />
	<Button class="mt-3 ml-3 absolute" icon="pi pi-arrow-left" @click="router.push('/')" label="Voltar" text
		raised></Button>
		...
		<div class="flex flex-column align-items-center justify-content-center">
			<form class="form-container" @submit.prevent="handleSubmit">
				<div
					...
					<div class="w-full surface-card py-8 px-8 sm:px-8" style="border-radius: 53px">
						...
						<div class="text-center mb-5">
							<img loading="lazy" src="@/assets/images/cards/profilePic.png" alt="Image" height="100" />
						...
						<div>
							<label for="email1"
								class="block text-900 text-xl font-medium mb-2">{{ $t('Login.User') }}</label>
							<InputText id="email1" v-model="form.login" type="text" :placeholder="$t('Login.User')"
								class="w-full md:w-30rem mb-5" style="padding: 1rem" />

							<label for="password1"
								class="block text-900 font-medium text-xl mb-2">{{ $t('Login.Password') }}</label>
