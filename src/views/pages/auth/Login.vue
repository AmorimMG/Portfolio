...
<template>
  <div class="login-page">
    ...
    <Background />
    <Button
      class="botao-absoluto mt-3 ml-3"
    ...
    <div
      class="wrapper w-full h-full flex align-items-center justify-content-center overflow-hidden"
    >
      <div class="w-full">
        <form
            ...
            <div class="w-full py-8 px-8 sm:px-8 rounded-[53px]">
              ...
              <div class="mt-5 flex flex-col items-center text-center mb-5">
                <img
                  ...
                  width="100"
                  height="100"
                  src="@/assets/images/cards/profilePic.png"
                  alt="Image"
                />
                <div class="text-white text-3xl font-medium mb-3">
                  {{ $t("Login.Welcome") }}
                </div>
              ...
              <div>
                ...
                <label
                  for="password-input"
                  class="block text-white font-medium text-xl w-full mb-3"
                >
                  {{ $t("Login.Password") }}
                </label>
                <Password
