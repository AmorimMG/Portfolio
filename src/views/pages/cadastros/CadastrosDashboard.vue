...
<template>
    <div v-if="canLoadIframe" class="iframe-container">
        <iframe v-show="!showFallback" class="iframe" :src="iframeUrl" @error="showFallback = true" scrolling="auto"
            style="border: none" />
    </div>
                ...
                <div class="col-span-12 xl:col-span-6 flex flex-col gap-2">
                        ...
                        <DataTable :value="products" :rows="5" :paginator="true" responsiveLayout="scroll">
                            <Column style="width: 15%">
                                ...
                                <template #body="slotProps">
                                    <img loading="lazy" :src="'demo/images/product/' + slotProps.data.image"
                    ...
                    <div class="card-dashboard">
                        ...
                        <ul class="list-none p-0 m-0">
                            <li class="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                                <div>
