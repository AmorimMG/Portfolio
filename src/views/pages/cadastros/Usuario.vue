...
<template>
    <div class="card">
        <h5 class="p-card-title">{{ this.formatMessage('gblUsuarios') }}</h5>
            ...
            <div v-else>
                ...
                >
                    ...
                    <Column headerStyle="min-width:10rem;">
                        <template #body="slotProps">
                            <Button v-tooltip="this.formatMessage('gblEditar')" icon="pi pi-pencil" class="p-button-rounded p-button-success mr-2" @click="editaUsuario(slotProps.data)" />
