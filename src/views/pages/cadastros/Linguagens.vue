        ...
        SalvaLinguagem() {
            RESTAPI.LinguagemCriar(this.Linguagem)
                .then(() => {
                    ...
                    this.toast.add({ severity: 'success', summary: this.formatMessage('gblSummarioToastSucesso'), detail: this.formatMessage('gblLinguagemToastCreate'), life: 3000 });
                    this.Linguagem = { admin: false };
                })
                .catch(() => {
                    this.toast.add({ severity: 'error', summary: this.formatMessage('gblSummarioToastError'), detail: this.formatMessage('gblLinguagemToastCreateError'), life: 3000 });
                });
        },
        EditaLinguagem() {
            RESTAPI.LinguagemEditar(this.userLogin)
                .then(() => {
                    this.getUsers();
                    this.editaDialog = false;
                    this.toast.add({ severity: 'success', summary: this.formatMessage('gblSummarioToastSucesso'), detail: this.formatMessage('gblLinguagemToastEdit'), life: 3000 });
                })
                .catch(() => {
                    this.toast.add({ severity: 'error', summary: this.formatMessage('gblSummarioToastError'), detail: this.formatMessage('gblLinguagemToastEditError'), life: 3000 });
                });
        },
        deleteUser() {
            RESTAPI.LinguagemExcluir(this.product.id)
                .then(() => {
                    ...
                    this.toast.add({ severity: 'success', summary: this.formatMessage('gblSummarioToastSucesso'), detail: this.formatMessage('gblLinguagemToastDelete'), life: 3000 });
                })
                .catch(() => {
                    this.toast.add({ severity: 'error', summary: this.formatMessage('gblSummarioToastError'), detail: this.formatMessage('gblLinguagemToastDeleteError'), life: 3000 });
                });
        },
...
<template>
    <div class="card">
        <h5 class="p-card-title">{{ this.formatMessage('gblLinguagem') }}</h5>
            ...
            <div v-else>
                <Toolbar class="mb-4">
                    <template v-slot:start>
                        <div class="my-2">
                            <Button :label="this.formatMessage('gblNovo')" icon="pi pi-plus" class="p-button-success mr-2" @click="openNew" />
                            <Button :label="this.formatMessage('gblDeletar')" icon="pi pi-trash" class="p-button-danger" @click="confirmDeleteAll" :disabled="selectedUser.length === 0" />
                        </div>
                    </template>
                ...
                >
                    ...
                    <Column headerStyle="min-width:10rem;">
                        <template #body="slotProps">
                            <Button v-tooltip="this.formatMessage('gblEditar')" icon="pi pi-pencil" class="p-button-rounded p-button-success mr-2" @click="editaLinguagem(slotProps.data)" />
                            <Button :disabled="slotProps.data?.id === this.userCookie?.id" v-tooltip="this.formatMessage('gblExcluir')" icon="pi pi-trash" class="p-button-rounded p-button-danger mt-2" @click="confirmDelete(slotProps.data)" />
                        </template>
                    </Column>
                </DataTable>
                ...
                <Dialog v-model:visible="deleteAllDialog" :header="this.formatMessage('gblExcluir')" :modal="true" :style="{ width: '450px' }">
                    <div class="flex align-items-center">
                        <i class="pi pi-exclamation-triangle mr-3" style="font-size: 2rem" />
                        <span v-if="product"
                            >{{ this.formatMessage('gblExcluir') }} <b>{{ this.selectedUser.length }} {{ this.formatMessage('gblLinguagem') }}</b
                            >?</span
                        >
                    </div>
                    <template #footer>
                ...
                <Dialog v-model:visible="criarDialog" :style="{ width: '450px' }" :header="this.formatMessage('gblCriar')" :modal="true" class="p-fluid">
                    ...
                    <template #footer>
                        ...
                        <Button :label="this.formatMessage('gblSalvar')" icon="pi pi-check" class="p-button-text" @click="SalvaLinguagem" />
                    </template>
                </Dialog>
                ...
                <Dialog v-model:visible="editaDialog" :style="{ width: '450px' }" :header="this.formatMessage('gblEditar')" :modal="true" class="p-fluid" @update:visible="getCancelUser">
                    ...
                    <template #footer>
                        ...
                        <Button :label="this.formatMessage('gblSalvar')" icon="pi pi-check" class="p-button-text" @click="EditaLinguagem" />
                    </template>
                </Dialog>
            </div>
        </div>
