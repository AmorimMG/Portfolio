...
const dropdownValue = ref({ name: 'English', code: 'US', value: "en" });
...
const gblInicio = ref(formatMessage('gblInicio'));
const gblHi = ref(formatMessage('gblHi'));
const gblAboutMe = ref(formatMessage('gblAboutMe'));
const gblInterests = ref(formatMessage('gblInterests'));
...
const commandHandler = (text) => {
    ...
    const commandLabels = ['help', 'date', 'greet', 'random', 'clear'];
...
const getSteamInfo = async (steamid, steamkey) => {
    fetch(`https://api.steampowered.com/ISteamUser/GetPlayerSummaries/v2/?key=${steamkey}&format=json&steamids=${steamid}`)
        .then((response) => response.json())
        .then((data) => {
            console.log(data.response.players[0]);
            steamData.value = data.response.players[0];
        })
        .catch((error) => console.error(error));
}

const getDiscordInfo = () => {
    fetch('https://api.lanyard.rest/v1/users/257165295427256320')
        .then((response) => response.json())
        .then((data) => {
            console.log(data);
...
<template>
    <div class="overlay" id="overlay" :class="{ 'active': overlayActive }"></div>
    ...
    <div v-if="isStarted">
        <div class="grid">
            <div class="col-12 lg:col-12 xl:col-6 glitch glitch--2">
                <div class="card mb-0">
                    <div class="mb-3" style="text-align: start">
                        ...
                        <p>
                            {{ gblAboutMe }}
                            <a :href="gblFiapLink" target="_blank" rel="noopener noreferrer"
                                style="color: #abcb1a" @mouseenter="toggle" class="underline">{{ gblFiap }}</a>
                        </p>
                        <br />
                        {{ gblInterests }}
                    </div>
                    ...
                    <div class="col-6">
                        <div class="row space-between" style="height: 100%">
                            <div class="card little-card mb-0 center" style="height: 100px">
                                <Dropdown :showClear="false" v-model="dropdownValue" :options="dropdownValues"
                                    optionLabel="name" class="dropdown flex align-items-center">
                            ...
                            <div class="card little-card mb-0 center" style="height: 100px">
                                <button @click="toggleOverlay" style="background: none; border: none;">
                                    <img id="image" src="/src/assets/images/bulb.png"
                                        :class="{ 'rotate': overlayActive }" width="50px" height="75px" />
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 lg:col-12 xl:col-3">
                <div v-if="spotifyData" class="card" style="height: 234px; background-color: #1db954;">
                    <h5 class="lights" style="margin-left: 12%;margin-top: 20px;">LISTENING TO SPOTIFY...</h5>
                    <div class="spotify">
                        <img :src="spotifyData?.album_art_url"
                            style="border: solid 0.5px #1db954; width: 80px; height: 80px; border-radius: 10px; margin-right: 15px" />
                        <div style="color: #999; margin-top: -3px; line-height: 1; width: 140px;">
                            <p
                                style="height: 15px; color: #fff; font-weight: bold; font-size: 0.85rem; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; margin: 7px 0">
                                {{ spotifyData?.song }} </p>
                            <p
                                style="margin: 7px 0; height: 15px; overflow: hidden; white-space: nowrap; font-size: 0.85rem; text-overflow: ellipsis; color: #ccc">
                                {{ spotifyData?.album }}</p>
                        </div>
                    </div>
                </div>
                <div v-else class="card mb-0 center">
                    <h2>SPOTIFY</h2>
                    <p class="lights">OFFLINE</p>
                </div>
            </div>
        </div>
        <div class="grid">
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                <a href="https://github.com/AmorimMG" target="_blank" rel="noopener noreferrer">
                    <div class="card mb-0 flex justify-content-center align-items-center"
                        @mouseenter="isHoveredGithub = true" @mouseleave="isHoveredGithub = false"
                        :class="{ hover: isHoveredGithub }" style="background-color: #f9CF87">
                        <img v-if="!isHoveredGithub" src="/src/assets/images/github.png" width="100px" height="100px" />
                        <img v-if="isHoveredGithub" class="lights" src="/src/assets/images/github.png" width="100px"
                            height="100px" />
                    </div>
                </a>
            </div>
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                <a href="mailto:gabriel@amorim.pro">
                <div class="card mb-0 center" style="background-size: 375px ; background-position: center;" :style="{backgroundImage: 'url(/src/assets/images/Mail.png)'}">
                </div>
            </a>
            </div>
            <div class="col-12 lg:col-12 xl:col-3 space-between">
            ...
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                <div class="card mb-0 center" style="height: 234px; background-color: #3730a3"
                    @mouseenter="isHovered = true" @mouseleave="isHovered = false" :class="{ hover: isHovered }">
                    <a href="https://discord.gg/58Peypm4" target="_blank" rel="noopener noreferrer">
                        <img v-if="!isHovered" src="/src/assets/images/staticdiscordspinner.png" width="400px"
                            height="300px" />
                        <img v-if="isHovered" class="lights" src="/src/assets/images/discordspinner.gif" width="400px"
                            height="300px" />
                    </a>
                </div>
            </div>
        ...
        <div class="grid">
            <div class="col-12 lg:col-12 xl:col-3">
                <a href="https://www.linkedin.com/in/gabrielamorim0/" target="_blank" rel="noopener noreferrer">
                    <div class="card mb-0 center" style="background-size: cover"
                        :style="{ backgroundImage: 'url(/src/assets/images/linkedin.jpeg)' }">
                    </div>
                </a>
            </div>
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                <div class="card mb-0 center" style="background-color: #9730a3" @mouseenter="isHoveredInstagram = true"
                    @mouseleave="isHoveredInstagram = false" :class="{ hover: isHoveredInstagram }">
                    <a href="https://www.instagram.com/amorim.gg_/" target="_blank" rel="noopener noreferrer">
                        <img v-if="!isHoveredInstagram" src="/src/assets/images/instagram.png" width="150px"
                            height="150px" />
                        <img v-if="isHoveredInstagram" class="lights" src="/src/assets/images/instagram.png"
            ...
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                ...
                <div class="card mb-0 center" @mouseenter="isHoveredSteam = true" @mouseleave="isHoveredSteam = false"
                    :class="{ hover: isHoveredSteam }" style="background-size: cover;"
                    :style="{ backgroundImage: 'url(/src/assets/images/steamlogo.jpg)' }">
                    <h2>STEAM</h2>
                    <a :href="steamData.profileurl" target="_blank" rel="noopener noreferrer">
                        <img v-if="!isHoveredSteam" :src="steamData.avatarfull" width="150px" height="150px" />
                        <img v-if="isHoveredSteam" class="lights"
                            src="https://cdn.cloudflare.steamstatic.com/steamcommunity/public/images/items/1892420/6a93ba5ed4cda296ae84002f871148f43727abdc.gif"
                            width="150px" height="150px" />
                    </a>
                </div>
            </div>
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                <div class="card mb-0 center" :style="{ backgroundColor: online ? '#35AC8C' : '#FF5733' }">
                    ...
                    <h2 v-if="online"><span class="dot"></span> ONLINE</h2>
                    <h2 v-else><span class="dot"></span> OFFLINE</h2>
                </div>
            </div>
        </div>
        <div class="grid">
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                <div class="card mb-0 center" style="background-size: cover; opacity: 0.5" :style="{backgroundImage: 'url(/src/assets/images/offline.webp)'}">
                    <h3 class="lights" style="opacity: 1">Tracking Offline <span class="red-dot"></span></h3>
                </div>
            </div>
            <div class="col-12 lg:col-12 xl:col-3">
                <div class="card mb-0 center" style="background-size: cover;"
                    :style="{ backgroundImage: !isDay ? 'url(/src/assets/images/day.jpg)' : 'url(/src/assets/images/night.jpg)' }">
                    <h2 class="greenLights">{{ currentTime }}</h2>
                    <h5 class="greenLights">in Brazil</h5>
                </div>
            </div>
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                <div class="card mb-0 flex justify-content-center align-items-center" style="height: 234px">
            ...
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                <div class="card mb-0 center" style="height: 258px; padding: 0;">
        ...
        <div class="grid">
            <div class="col-12 lg:col-12 xl:col-6 space-between">
                <div class="mb-0 center" style="height: 258px">
                    <Terminal class="custom-terminal" :welcomeMessage="'Welcome to Amorim. ' + 'Type \'help\' for commands'" prompt="portfolio@amorim:~$ " aria-label="PrimeVue Terminal Service"/>
                </div>
            </div>
            <div class="col-12 lg:col-12 xl:col-6 glitch glitch--1">
                <div class="card mb-0 flex justify-content-center flex-column">
                    <h2>MY STACK</h2>
                    <div class="m-4 mb-0 grid w-full grid-cols-7 flex-wrap justify-center gap-2 self-center sm:m-4 sm:mb-14 sm:grid-cols-7 sm:gap-2 md:grid-cols-10 md:gap-4"
                        ...
                        <span class="lights">
                            ...
                            </svg></span><span class="lights h-full"><svg stroke="currentColor" fill="currentColor"
        ...
        <div class="grid">
            <div class="col-12 lg:col-12 xl:col-12">
                <div class="card mb-0 center" style="height: 258px">
        ...
        <Dialog v-model="cvVisible" @update:visible="closePopup()" :maximized="true" :visible="cvVisible" :modal="true"
...
.p-overlaypanel-content {
    background-color: #4d25b0 !important;
    border-color: #abcb1a;
    border-style: solid;
}

.lights {
    filter: drop-shadow(0 0 4px purple) drop-shadow(0 0 6px purple) drop-shadow(0 0 10px purple);
}

.greenLights {
    filter: drop-shadow(0 0 4px #abcb1a) drop-shadow(0 0 6px #abcb1a) drop-shadow(0 0 10px #abcb1a);
}
...
.custom-terminal .p-terminal-content {
    color: white;
}

.custom-terminal .p-terminal-welcome-msg,
.custom-terminal .p-terminal-prompt {
    color: green;
}
</style>
