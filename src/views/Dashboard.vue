...
const commandHandler = (text) => {
    ...
    const commandLabels = ['help', 'date', 'greet', 'random', 'clear', 'hobbies'];
    ...
    switch (command) {
        ...
        case 'random':
            ...
            break;
        case 'hobbies':
            response = 'I Like to programm, playing with my friends and reading! :) ';
            break;
        case 'clear':
            clearTerminal();
    ...
    <div v-if="isStarted">
        <div class="grid">
            <div class="col-12 lg:col-12 xl:col-6 glitch glitch--2">
                <div class="card mb-0" style="user-select: text">
                    <div class="mb-3" style="text-align: start">
                        <h3 class="center">{{ translations.gblHi }}</h3>
                        <br />
                        <p style="font-size: 18px">
                            {{ translations.gblAboutMe }}
                            <a href="https://www.fiap.com.br/" target="_blank" rel="noopener noreferrer" style="color: #abcb1a" @mouseenter="toggle" class="underline">FIAP</a>
                        </p>
                        <br />
                ...
                <div class="card row flex" style="height: 250px; padding: 0">
                    <div class="col-6">
                        <div class="row space-between" style="height: 100%">
                            ...
                            <div class="card little-card mb-0 center" style="height: 100px; cursor: pointer">
                                <button @click="appConfigRef.onDarkModeChange(toggleOverlay(!overlayActive))" style="background: none; border: none">
                                    <img id="image" src="/src/assets/images/bulb.png" :class="{ rotate: overlayActive }" width="50px" height="75px" style="cursor: pointer" />
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 lg:col-12 xl:col-3">
                <div v-if="spotifyData" class="card" style="height: 234px; background-color: #1db954">
                    <h5 class="lights" style="margin-left: 12%; margin-top: 20px">{{ translations.gblSpotify }}...</h5>
                    <div class="spotify">
                        <img :src="spotifyData?.album_art_url" style="border: solid 0.5px #1db954; width: 80px; height: 80px; border-radius: 10px; margin-right: 15px" />
                        <div style="color: #999; margin-top: -3px; line-height: 1; width: 140px">
                            <p style="color: white; text-overflow: ellipsis">
                                {{ spotifyData?.song }}
                            </p>
                            <p style="color: white; text-overflow: ellipsis">
                                {{ spotifyData?.album }}
                ...
                <div v-else class="card mb-0 center" style="background-color: #ff5733">
                    <h2 class="lights">SPOTIFY</h2>
                    <h6 class="lights">OFFLINE</h6>
                </div>
            </div>
        </div>
        <div class="grid">
            <div class="col-12 lg:col-12 xl:col-3 space-between" :class="{ isLink: isLink }">
                <a href="https://github.com/AmorimMG" target="_blank" rel="noopener noreferrer">
                    <div class="card mb-0 flex justify-content-center align-items-center" @mouseenter="isHoveredGithub = true" @mouseleave="isHoveredGithub = false" style="background-color: #f9cf87">
                        <img src="/src/assets/images/github.png" width="100px" height="100px" :class="{ lights: isHoveredGithub }" />
                    </div>
                </a>
            </div>
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                <a href="mailto:gabriel@amorim.pro">
                    <div class="card mb-0 center" style="background-color: #7225d6" @mouseenter="isHoveredMail = true" @mouseleave="isHoveredMail = false">
                        <img src="/src/assets/images/Mail.png" width="200px" :class="{ lights: isHoveredMail }" />
                    </div>
                </a>
            </div>
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                <div class="card mb-0 flex justify-content-center align-items-center" style="height: 234px">AAAAAAAAA</div>
            </div>

            <div class="col-12 lg:col-12 xl:col-3 space-between" :class="{ isLink: isLink }">
                <div class="card mb-0 center" style="height: 234px; background-color: #3730a3" @mouseenter="isHovered = true" @mouseleave="isHovered = false">
                    <a href="https://discord.gg/58Peypm4" target="_blank" rel="noopener noreferrer">
                        <img v-if="!isHovered" src="/src/assets/images/staticdiscordspinner.png" width="400px" height="300px" />
                        <img v-if="isHovered" class="lights" src="/src/assets/images/discordspinner.gif" width="400px" height="300px" />
                    </a>
                </div>
            </div>
        </div>
        <div class="grid">
            <div class="col-12 lg:col-12 xl:col-3" :class="{ isLink: isLink }">
                <a href="https://www.linkedin.com/in/gabrielamorim0/" target="_blank" rel="noopener noreferrer" @mouseenter="isHoveredLinkedin = true" @mouseleave="isHoveredLinkedin = false">
                    <div class="card mb-0 center" style="background-color: #0274b3">
                        <img src="/src/assets/images/linkedin.jpeg" width="200px" height="200px" :class="{ lights: isHoveredLinkedin }" />
                    </div>
                </a>
            </div>
            <div class="col-12 lg:col-12 xl:col-3 space-between" :class="{ isLink: isLink }">
                <a href="https://www.instagram.com/amorim.gg_/" target="_blank" rel="noopener noreferrer">
                    <div class="card mb-0 center" style="background-color: #9730a3" @mouseenter="isHoveredInstagram = true" @mouseleave="isHoveredInstagram = false">
                        <img src="/src/assets/images/instagram.png" width="150px" height="150px" :class="{ lights: isHoveredInstagram }" />
                    </div>
                </a>
            </div>
            <div class="col-12 lg:col-12 xl:col-3 space-between">
                <div
                    class="card mb-0 center"
                ...
                >
                    ...
                    <a :href="steamData.profileurl" target="_blank" rel="noopener noreferrer">
                        ...
                        <img v-if="isHoveredSteam" class="lights" src="https://cdn.cloudflare.steamstatic.com/steamcommunity/public/images/items/1892420/6a93ba5ed4cda296ae84002f871148f43727abdc.gif" width="150px" height="150px" />
                    </a>
                </div>
            </div>
            <div class="col-12 lg:col-12 xl:col-3 space-between">
        ...
        <div class="grid">
            ...
            <div class="col-12 lg:col-12 xl:col-3">
                <div class="card mb-0 center" style="background-size: cover" :style="{ backgroundImage: !isDay ? 'url(/src/assets/images/day.jpg)' : 'url(/src/assets/images/night.jpg)' }">
                    ...
                    <h5 class="greenLights">{{ translations.gblBrazil }}</h5>
                </div>
            </div>
            <div class="col-12 lg:col-12 xl:col-3 space-between">
