...
<template>
    <div class="grid">
        <div class="col-12 lg:col-12 xl:col-9">
            <div class="card mb-0">
                <div class="flex  mb-3" style="text-align: start;">
                    <img src="https://static.wikia.nocookie.net/liberproeliis/images/b/b5/Aqj3am4.png/revision/latest?cb=20230823152941&path-prefix=pt-br"
                        width="400vw" height="130vh"/>
        ...
        <div class="col-12 lg:col-12 xl:col-3 flex flex-column justify-content-between">
            <div class="card mb-0 flex justify-content-center ">

                    <img src="https://static.wikia.nocookie.net/liberproeliis/images/b/b5/Aqj3am4.png/revision/latest?cb=20230823152941&path-prefix=pt-br"
                    width="170vw" height="35vh"/>
            </div>
            <div class="card mb-0 flex justify-content-center">
                <img src="https://static.wikia.nocookie.net/liberproeliis/images/b/b5/Aqj3am4.png/revision/latest?cb=20230823152941&path-prefix=pt-br"
                width="170vw" height="35vh"/>
