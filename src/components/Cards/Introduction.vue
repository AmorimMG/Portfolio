...
<template>
    <div class="page" :style="{ display: menuVisible ? 'flex' : 'none' }">
        <div class="flex flex-col justify-content-between m-3" style="text-align: start; position: relative">
            <div class="settings">
            ...
            <div class="upper">
                <div class="flex flex-row justify-content-between m-3">
                    <div class="center flex-row gap-2" style="color: white"><i class="pi pi-comment"></i> {{
                        $t('AboutMeButton') }}
                    </div>
                    <div class="flex gap-3">
            ...
            <div class="bottom">
                <div class="flex flex-row justify-content-between m-3">
                    <div class="center flex-row gap-2" style="color: white"><i class="pi pi-phone"></i> {{
                        $t('Contact.title') }}
                    </div>
                </div>
