...
<template>
    <div class="portfolio-root" v-bind="$attrs">
        <Button text class="w-full h-full" @click="emit('update:visible', true)" />
        <CustomDialog
        ...
        >
            <template #header>
                <div class="safari-header w-full flex items-center justify-between px-3 py-2 bg-neutral-100 border-b border-neutral-300">
                    ...
                    <input disabled v-model="url" class="bg-zinc-800 text-white text-sm font-medium px-3 py-1 rounded-lg shadow-inner ml-3 w-full max-w-lg" placeholder="Enter URL..." />
                    <div class="w-10"></div>
                </div>
            </template>
