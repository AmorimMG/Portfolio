            ...
            <div class="gap-4">
                <span v-tooltip.bottom="'Vite'" class="lights mr-4 h-full">
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'React'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Next'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Tailwind'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Vscode'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'NodeJS'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Express'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Javascript'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'TypeScript'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Astro'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Jest'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Java'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'SpringBoot'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Spring'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Postgre'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Git'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Docker'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'AWS'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                ...
                ><span v-tooltip.bottom="'Next'" class="lights mr-4 h-full"
                    ...
                    >
                        ...
                        ></path></svg></span
                ><span v-tooltip.bottom="'Jenkins'" class="lights mr-4 h-full"
                    ><svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
