...
<template>
  ...
  <TerminalModal
    @close="displayTerminal = false"
    v-model:visible="displayTerminal"
  />
  <FileSystemModal
    @close="FileSystemOpen = false"
    v-model:visible="FileSystemOpen"
  />
  <TrashModal @close="TrashOpen = false" v-model:visible="TrashOpen" />
  <VscodeModal
    @close="vscodeModalOpen = false"
    v-model:visible="vscodeModalOpen"
  />
  <PortfolioModal
    @close="portfolioModalOpen = false"
    v-model:visible="portfolioModalOpen"
  />
  <PhotosModal @close="displayPhotos = false" v-model:visible="displayPhotos" />
  <Dialog
